...
public class Model {
    ...
    //photo section
//////////
    public interface DeletePostPhotoListener {
        public void onComplete();
    }

    public void deletePostPhoto(String name, Model.DeletePostPhotoListener listener) {
        modelFirebase.deletePostPhoto(name,listener);

    }



    public interface DeleteUserPhotoListener {
        public void onComplete();
    }

    public void deleteUserPhoto(String name, Model.DeleteUserPhotoListener listener) {
